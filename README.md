...
If you look into the data both donors table , receivers table have 3 columns in common:

**Denomination**  → Value of the bond
**Prefix**       → The first 2 letters of bond
**Bond Number**  → 5 digit number followed by


Just like your currency your bond has a value.

![image](https://github.com/user-attachments/assets/3731b1b5-2573-41e9-8786-43e94e333b97)


If you take these attributes individually then multiple bonds can have same prefix and multiple bonds can have same bond number just like your currency but the combination makes sure they are unique like no currency has the same sequence number and this is going to act as our primary key and simultaneouly the attribute with which we can find out which bond is delivered to which political party and who gave it
